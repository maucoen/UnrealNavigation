...
UnrealNavigation-Linux-Debug:
	 $(PROJECTBUILD) UnrealNavigation Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigation-Linux-DebugGame:
	 $(PROJECTBUILD) UnrealNavigation Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigation-Linux-Shipping:
	 $(PROJECTBUILD) UnrealNavigation Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigation-Linux-Test:
	 $(PROJECTBUILD) UnrealNavigation Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigation:
	 $(PROJECTBUILD) UnrealNavigation Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigationEditor-Linux-Debug:
	 $(PROJECTBUILD) UnrealNavigationEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigationEditor-Linux-DebugGame:
	 $(PROJECTBUILD) UnrealNavigationEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigationEditor-Linux-Shipping:
	 $(PROJECTBUILD) UnrealNavigationEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigationEditor-Linux-Test:
	 $(PROJECTBUILD) UnrealNavigationEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealNavigationEditor:
	 $(PROJECTBUILD) UnrealNavigationEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
