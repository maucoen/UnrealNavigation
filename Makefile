...
CamPipe-Linux-Debug:
	 $(PROJECTBUILD) CamPipe Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipe-Linux-DebugGame:
	 $(PROJECTBUILD) CamPipe Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipe-Linux-Shipping:
	 $(PROJECTBUILD) CamPipe Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipe-Linux-Test:
	 $(PROJECTBUILD) CamPipe Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipe:
	 $(PROJECTBUILD) CamPipe Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipeEditor-Linux-Debug:
	 $(PROJECTBUILD) CamPipeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CamPipeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipeEditor-Linux-Shipping:
	 $(PROJECTBUILD) CamPipeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipeEditor-Linux-Test:
	 $(PROJECTBUILD) CamPipeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CamPipeEditor:
	 $(PROJECTBUILD) CamPipeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
