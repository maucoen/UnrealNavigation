...
CamPipeRootPath=/home/mau/EPIC/Projects/CamPipe

gameProjectFile=/home/mau/EPIC/Projects/CamPipe/CamPipe.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(CamPipeSource.pri)
include(CamPipeHeader.pri)
include(CamPipeConfig.pri)
include(CamPipeIncludes.pri)
include(CamPipeDefines.pri)
...
CamPipe-Linux-Debug.commands = $$build CamPipe Linux Debug  -project="\"$$gameProjectFile\"" $$args
CamPipe-Linux-DebugGame.commands = $$build CamPipe Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CamPipe-Linux-Shipping.commands = $$build CamPipe Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CamPipe-Linux-Test.commands = $$build CamPipe Linux Test  -project="\"$$gameProjectFile\"" $$args
CamPipe.commands = $$build CamPipe Linux Development  -project="\"$$gameProjectFile\"" $$args

CamPipeEditor-Linux-Debug.commands = $$build CamPipeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
CamPipeEditor-Linux-DebugGame.commands = $$build CamPipeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CamPipeEditor-Linux-Shipping.commands = $$build CamPipeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CamPipeEditor-Linux-Test.commands = $$build CamPipeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
CamPipeEditor.commands = $$build CamPipeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	CamPipe-Linux-Debug \
	CamPipe-Linux-DebugGame \
	CamPipe-Linux-Shipping \
	CamPipe-Linux-Test \
	CamPipe \
	CamPipeEditor-Linux-Debug \
	CamPipeEditor-Linux-DebugGame \
	CamPipeEditor-Linux-Shipping \
	CamPipeEditor-Linux-Test \
	CamPipeEditor \
