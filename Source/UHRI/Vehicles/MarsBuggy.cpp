...
const FName AMarsBuggy::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

AMarsBuggy::AMarsBuggy()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UBackWheelMarsBuggy::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UBackWheelMarsBuggy::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UMidWheelMarsBuggy::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UMidWheelMarsBuggy::StaticClass();
...
void AMarsBuggy::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AMarsBuggy::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AMarsBuggy::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AMarsBuggy::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AMarsBuggy::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AMarsBuggy::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AMarsBuggy::OnResetVR);
}
...
void AMarsBuggy::OnHandbrakeReleased()
{
...
void AMarsBuggy::UpdateHUDStrings()
{
...
void AMarsBuggy::UpdatePhysicsMaterial()
{
