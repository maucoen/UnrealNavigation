...
// Sets default values
ASixWheelCharacter::ASixWheelCharacter()
{
...
void ASixWheelCharacter::BeginPlay()
{
	Super::BeginPlay();
	Super::BeginPlay();
	SetBoneArrays();
...
void ASixWheelCharacter::SetBoneArrays()
{
...
TArray<FName> ASixWheelCharacter::FindControlStructures(FName Name)
{
...
void ASixWheelCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ASixWheelCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ASixWheelCharacter::MoveRight);
	PlayerInputComponent->BindAxis("LeftTouchpadY", this, &ASixWheelCharacter::MoveForward);
	PlayerInputComponent->BindAxis("LookUp", this, &ASixWheelCharacter::ViewUp);
	PlayerInputComponent->BindAxis("Turn", this, &ASixWheelCharacter::ViewRight);
	PlayerInputComponent->BindAxis("ZoomIn", this, &ASixWheelCharacter::ZoomIn);
	PlayerInputComponent->BindKey(EKeys::B, EInputEvent::IE_Pressed, this, &ASixWheelCharacter::ToggleDrawControls);
}

void ASixWheelCharacter::ViewRight(float Val)
{
	if (Val != 0)
	{
...
void ASixWheelCharacter::ViewUp(float Val)
{
	if (Val != 0)
	{
		Val = Val * GetWorld()->GetDeltaSeconds() * -45;
...
void ASixWheelCharacter::ZoomIn(float Val)
{
	MastCam->SetFieldOfView(MastCam->FieldOfView - Val);
}

void ASixWheelCharacter::MoveForward(float Val)
{
	if (Val != 0)
	{
...
void ASixWheelCharacter::MoveRight(float Val)
{
...
void ASixWheelCharacter::ToggleDrawControls()
{
	bDraw = !bDraw;
}

void ASixWheelCharacter::DrawVectors(FName Bone, FVector Torque)
{
	if (bDraw)
	{
