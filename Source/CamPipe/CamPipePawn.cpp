...
#include "CamPipeWheelFront.h"
#include "CamPipeWheelRear.h"
...
const FName ACamPipePawn::LookUpBinding("LookUp");
const FName ACamPipePawn::LookRightBinding("LookRight");
const FName ACamPipePawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

ACamPipePawn::ACamPipePawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UCamPipeWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UCamPipeWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UCamPipeWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UCamPipeWheelRear::StaticClass();
...
void ACamPipePawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ACamPipePawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ACamPipePawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ACamPipePawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ACamPipePawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ACamPipePawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACamPipePawn::OnResetVR); 
}
...
void ACamPipePawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ACamPipePawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ACamPipePawn::EnableIncarView(const bool bState)
{
...
void ACamPipePawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ACamPipePawn::UpdateHUDStrings()
{
...
void ACamPipePawn::SetupInCarHUD()
{
...
void ACamPipePawn::UpdatePhysicsMaterial()
{
